    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        playbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(MediaPlayerEx.this, "Start Audio", Toast.LENGTH_SHORT).show();
                mPlayer.start();
        ...
        pausebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(MediaPlayerEx.this, "Paused", Toast.LENGTH_SHORT).show();
            }
        });
        forwardbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if((sTime+fTime) <= eTime){
                    ...
                    Toast.makeText(MediaPlayerEx.this, "Cannot jump forward  5 sec", Toast.LENGTH_SHORT).show();
                }
